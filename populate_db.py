...
giraffe1_toy1 = Toy(name='Antlers', toy_type='Sensory',
    ...
    photo='''
    http://cdn0.wideopenspaces.com/wp-content/uploads/2014/01/featured-antlers.jpg''',
...
giraffe1_toy3 = Toy(name='Pinecones', toy_type='Manipulative',
    ...
    photo='http://www.timespub.tc/wp-content/uploads/2012/01/Pine-cones-1.jpg',
    animal=giraffe1, user_id=1)
...
gorilla1_toy1 = Toy(name='TV/Videos', toy_type='Sensory',
    ...
    a day.''',
    photo='''
    http://sugikingdom.com/wp-content/uploads/2016/12/2017-TV-GUide.jpg''',
...
gorilla1_toy3 = Toy(name='Tug-o-war', toy_type='Behavioral/Social',
    ...
    photo='''
    https://www.globalbodyweighttraining.com/wp-content/uploads/GBT-Manila-Rope-Knot.jpg
    ''', animal=gorilla1, user_id=1)
...
elephant1 = Animal(name='Zuri', age=10, species='Elephant',
    photo='''
    https://static1.squarespace.com/static/5304f39be4b0c1e749b456be/t/58cc06d96a49637cb9ed84a6/1489766903764/
    ''', user_id=1)
...
elephant1_toy_1 = Toy(name='Bubbles', toy_type='Sensory',
    ...
    photo='''
    https://assets.bwbx.io/images/users/iqjWHBFdfxIU/iz9tFMUcP6rI/v1/1200x-1.jpg
...
tiger1 = Animal(name='Kazek', age=13, species='Tiger',
    photo='''
    http://www.wildaid.org/sites/default/files/photos/iStock_000008484745Large%20%20tiger%20-%20bengal.jpg
    ''', user_id=1)
...
tiger1_toy1 = Toy(name='Disco Ball', toy_type='Sensory',
    ...
    photo='''
    https://images-na.ssl-images-amazon.com/images/I/61ynRSp-T1L._SY355_.jpg
...
crocodile1 = Animal(name='Kwan', age=6, species='Crocodile',
    photo='''
    https://s-media-cache-ak0.pinimg.com/736x/8d/92/2e/8d922e642ce725024ec741bff8bc7175--darwin-australia-saltwater-crocodile.jpg
    ''', user_id=1)
...
crocodile1_toy1 = Toy(name='Branches', toy_type='Environmental',
    ...
    photo='''
    http://cdn3.volusion.com/uakvg.mdecs/v/vspfiles/photos/BBNR18-2.jpg?1420709474
...
eagle1 = Animal(name='Sam', age=4, species='Bald Eagle',
    photo='https://identify.whatbird.com/img/4/48397/image.aspx?x=322',
    user_id=1)
...
eagle1_toy1 = Toy(name='Straw Pile', toy_type='Environmental',
    ...
    photo='''
    https://blenderartists.org/forum/attachment.php?attachmentid=218183&d=1361347213
